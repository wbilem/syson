 ...
 * @author wbilem
 */
public class AttributeUsageWithRedefinitionAndFeatureChainExpressionTestModel {
    ...
    private final AttributeUsage redefiniedDrives;

    public AttributeUsageWithRedefinitionAndFeatureChainExpressionTestModel() {
        ...
        this.redefiniedDrives = this.builder.create(AttributeUsage.class);
    ...
    private void createFeatureChainExpressionWithFeatureChaining(FeatureValue container, AttributeUsage attr1, AttributeUsage attr2, AttributeUsage attr3) {
        ...
        Redefinition redefinition = this.builder.createIn(Redefinition.class, this.redefiniedDrives);
        redefinition.setRedefinedFeature(this.drives);
        redefinition.setRedefiningFeature(this.redefiniedDrives);
        chaining1.setChainingFeature(this.redefiniedDrives);
